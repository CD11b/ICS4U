...
player = Player(200, 200, 82, 49, 'player', 6)
...
while run:
    ...
    for bullet in bullets:
        ...
        if bullet.y - bullet.radius < guard.hitbox[1] + guard.hitbox[3] and bullet.y + bullet.radius > \
                guard.hitbox[1]:
            if bullet.x + bullet.radius > guard.hitbox[0] and bullet.x - bullet.radius < guard.hitbox[0] + \
                    guard.hitbox[2]:
                guard.hit()
